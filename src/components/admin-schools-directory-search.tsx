...
export function AdminSchoolsDirectorySearch({ initialValue }: { initialValue: string }) {
  ...
  return (
    <div className="grid gap-2 sm:max-w-md">
      <Label htmlFor="admin-schools-q">Search schools</Label>
      <div className="flex gap-2">
        <Input
          id="admin-schools-q"
          value={q}
          onChange={(e) => setQ(e.target.value)}
          placeholder="Type school name, nickname, slug or town"
          autoComplete="off"
        />
        {q ? (
